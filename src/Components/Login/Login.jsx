  ...
  return (
    <div className='h-full flex items-center justify-center'>
      <div className='flex bg-red-700 w-half h-half'>
        ...
        <div className='bg-slate-800 w-6/12 py-10'>
          ...
          <form className='mt-16 w-12/12 flex flex-col gap-6 items-center justify-center' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col w-8/12 text-white text-lg'>
              <label>Email</label>
              <input type='email' className='text-black bg-transparent outline-none border-b-2 border-green-500' />
            </div>
            <div className='flex flex-col w-8/12 text-white text-lg'>
              <label>Password</label>
              <input type='password' className='text-black bg-transparent outline-none border-b-2 border-green-500' />
            </div>
