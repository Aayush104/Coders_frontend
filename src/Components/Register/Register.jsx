  ...
  return (
    <div className='h-full flex items-center justify-center'>
      <div className='flex flex-col md:flex-row w-form lg:w-l_md h-half desktop:w-l_md l_desktop:w-half'>
        ...
        <div className=' bg-slate-800 m-mobile:w-8/12 mobile:mx-auto mobile:w-10/12 lg:w-6/12 py-8'>
          <div className='flex  flex-col justify-center items-center'>
            <p className='text-white capitalize text-medium font-bold '>get Started</p>
           <div className='flex gap-1 pl-4'>
            <span className='text-white text-center capitalize '>Already Have an account?</span>
...
<div className='flex flex-col gap-1 w-8/12 text-white text-md_text'>
           ...
           <label className='text-label'>Username</label>
            <input type='text' className=' bg-transparent outline-none border-b-2  border-green-500 text-white'></input>
           </div>
           ...
           <label className=' text-label'>Confirm Password</label>
            <input type='password' className=' bg-transparent outline-none border-b-2  border-green-500 text-white'></input>
           </div>
